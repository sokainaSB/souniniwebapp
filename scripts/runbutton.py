...
class MyBot:
    def __init__(self, url_input):
        try:
            ...
            screenshot_path = os.path.join("souniniapp", "static", "image", "screenshot.png")
...
if __name__ == "__main__":
    # Extract the URL from the command-line arguments or prompt the user
    if len(sys.argv) > 1:
